                    ...
                    >
                        ...
                        <div className="relative z-40 flex flex-col items-center text-center py-16 lg:py-20 px-6">
                            ...
                            <motion.h2
                                ...
                                className="text-3xl md:text-4xl lg:text-6xl font-medium bg-linear-to-r from-foreground to-foreground/70 text-transparent bg-clip-text leading-[1.2] mt-8 max-w-3xl"
                            >
                                The better way to
                                <br />
                                manage your work
                            ...
                            >
                                Join other creators and experts <br /> organizing your business today
                            </motion.p>
                            ...
                            <motion.div
                                ...
                                className="mt-6"
                            >
                                <Link href="mailto:team@nexeav.com">
                                    <Button size="lg" className="text-base" variant="ios">
                                        Mail Us
                                    </Button>
                                </Link>
                            </motion.div>
