...
import { NEXE_FEATURES, OTHER_TOOLS } from '@/constants/difference';
            ...
            <Wrapper>
                ...
                <div className="relative max-w-5xl mx-auto mt-12">
                    ...
                    <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 hidden lg:flex flex-col items-center justify-center lg:pt-14">
                        ...
                        <motion.div
                            className="relative z-10 size-14 rounded-full bg-background border-2 border-primary/40 flex items-center justify-center shadow-[0_0_30px_rgba(0,225,0,0.5)]"
