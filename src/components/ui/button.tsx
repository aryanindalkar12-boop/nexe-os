...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer select-none relative overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-linear-to-r from-primary via-green-500 to-primary bg-size-[200%_100%] bg-left hover:bg-right text-foreground shadow-lg hover:shadow-primary/25 border-0 active:scale-[0.98] transition-all duration-300",
        destructive:
        ...
        rigby:
          "bg-primary font-medium text-black ring-offset-2 ring-offset-black transition duration-500 hover:ring-2 hover:ring-primary rounded-full",
        ios:
          "bg-green-500 font-medium text-white ring-offset-2 ring-offset-black transition duration-500 hover:ring-2 hover:ring-green-500 rounded-full",
      },
      size: {
